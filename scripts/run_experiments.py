...
# Each experiment writes results to output/ as CSV for downstream plotting.
#
# Usage:
#   python3 scripts/run_experiments.py benchmark
#   python3 scripts/run_experiments.py convergence
#   python3 scripts/run_experiments.py hyperparam
#   python3 scripts/run_experiments.py runtime
#   python3 scripts/run_experiments.py optparams
